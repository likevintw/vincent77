...
extern "C" {
	...
	*/
	...
	SusiIoTStatus_t SUSI_IOT_API SusiIoTGetPFDataByUri(const char* uri, json_t *data);
	...
	const char *SUSI_IOT_API SusiIoTGetPFDataStringByUri(const char* uri);
	SusiIoTStatus_t SUSI_IOT_API SusiIoTSetPFDataString(const char* jsonString);
	...
	const char *SUSI_IOT_API SusiIoTGetLoggerPath();
